...
function updateStatus() {
  ...
  if (serialReturnEmergency == 01) {
    ...
    serialReturnState == 04 &&                      ////////////////////////// change 4 to 3
    ipc_state != STATE_FILL_STOP &&
    ipc_state != STATE_PORDUCT_SELECTION &&
    ipc_state != BUTTON_STOP
  ){
    if (ipc_state != STATE_FILL) {
      console.log("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF");                                            ////////////////////////////////////////////// refer ////////////////////////////////
...
function toggleText() {
  ...
  if ((x.textContent).trim() === 'বাঙালি') {
    x.textContent = 'English';
    lang_chng = 0;
  } else {
    x.textContent = 'বাঙালি';
    lang_chng = 1;
  }
...
// const fetchJson = async (idx) => {
  try {
    ...
    if (lang_chng == 0){
      ...
      divSelectedVolumePrice.innerHTML = selectedProductPrice;
      divConfirmedPrice.innerHTML = selectedProductPrice + " টাকা";

      if (selectedVolume >= 1000){
        divConfirmedVolume.innerHTML = selectedVolume/1000 + " লিটার";
        divSelectedVolume.innerHTML = selectedVolume/1000 + " লিটার";
      }else {
        divConfirmedVolume.innerHTML = selectedVolume + " মিলি";
        divSelectedVolume.innerHTML = selectedVolume + " মিলি";
      }
      ...
      document.getElementById("text-guid").style = "font-size: 45px; width: 50%;";

      document.getElementById("text-recpt1").textContent = ban_li[10];
      ...
      document.getElementById("divFillingText").style = "font-size: 60px; top: 70%; left: 33%";
      ...
      document.getElementById("text-print-receipt").style = "font-size: 50px;";

      document.getElementById("text-tot").textContent = ban_li[15];
      document.getElementById("text-tot").style = "font-size: 45px; left: 30%";

      document.getElementById("text-qnt").textContent = ban_li[16];
      document.getElementById("text-qnt").style = "font-size: 45px; left: 30%";
      ...
      vol6product1Detail2.textContent = "টাকা. " + productPrices.split("/")[0];
      vol6product1Detail3.textContent = "বাঁচবে টাকা. " + productDiscounts.split("/")[0]
      vol6product1Detail3.style = "font-size: 30px; color: blue; margin-top: -10px;";

      vol6product2Detail2.textContent = "টাকা. " + productPrices.split("/")[1];
      vol6product2Detail3.textContent = "বাঁচবে টাকা. " + productDiscounts.split("/")[1]
      vol6product2Detail3.style = "font-size: 30px; color: blue; margin-top: -10px;";

      vol6product3Detail2.textContent = "টাকা. " + productPrices.split("/")[2];
      vol6product3Detail3.textContent = "বাঁচবে টাকা. " + productDiscounts.split("/")[2]
      vol6product3Detail3.style = "font-size: 28px; color: blue; margin-top: -7px;";

      vol6product4Detail2.textContent = "টাকা. " + productPrices.split("/")[3];
      vol6product4Detail3.textContent = "বাঁচবে টাকা. " + productDiscounts.split("/")[3]
      vol6product4Detail3.style = "font-size: 28px; color: blue; margin-top: -7px;";

      vol6product5Detail2.textContent = "টাকা. " + productPrices.split("/")[4];
      vol6product5Detail3.textContent = "বাঁচবে টাকা. " + productDiscounts.split("/")[4]
      vol6product5Detail3.style = "font-size: 28px; color: blue; margin-top: -7px;";

      vol6product6Detail2.textContent = "টাকা. " + productPrices.split("/")[5];
      vol6product6Detail3.textContent = "বাঁচবে টাকা. " + productDiscounts.split("/")[5]
      ...
      if (productVolumes.split("/")[0] >= 1000){
        vol6product1Detail1.innerHTML = ban_li[20];
        $("div#vol6product1volml").hide();
        $("div#vol6product1vol1").show();
      }else{
        vol6product1Detail1.innerHTML = ban_li[20];
      ...
      if (productVolumes.split("/")[1] >= 1000){
        if (productVolumes.split("/")[1] == 200) vol6product2Detail1.innerHTML = ban_li[21];
        else if (productVolumes.split("/")[1] == 400) vol6product2Detail1.innerHTML = ban_li[22];
        $("div#vol6product2volml").hide();
        $("div#vol6product2vol1").show();
      }else{
        if (productVolumes.split("/")[1] == 200) vol6product2Detail1.innerHTML = ban_li[21];
      ...
      if (productVolumes.split("/")[2] >= 1000){
        if (productVolumes.split("/")[2] == 500) vol6product3Detail1.innerHTML = ban_li[23];
        else if (productVolumes.split("/")[2] == 800) vol6product3Detail1.innerHTML = ban_li[24];
        $("div#vol6product2volml").hide();
        $("div#vol6product2vol1").show();
      }else{
        if (productVolumes.split("/")[2] == 500) vol6product3Detail1.innerHTML = ban_li[23];
      ...
      if (productVolumes.split("/")[3] >= 1000){
        vol6product4Detail1.innerHTML = ban_li[25]
        $("div#vol6product4volml").hide();
        $("div#vol6product4vol1").show();
      }else{
        vol6product4Detail1.innerHTML = ban_li[25];
      ...
      if (productVolumes.split("/")[4] >= 1000){
        vol6product5Detail1.innerHTML = ban_li[26]
        $("div#vol6product5volml").hide();
        $("div#vol6product5vol1").show();
      }else{
        vol6product5Detail1.innerHTML = ban_li[26];
      ...
      if (productVolumes[5] >= 1000){
        vol6product6Detail1.innerHTML = ban_li[27]
        $("div#vol6product6volml").hide();
        $("div#vol6product6vol1").show();
      }else{
        vol6product6Detail1.innerHTML = ban_li[27]
    ...
    ///////////////////////////////////////////////////////////////////////////
      ...
      document.getElementById("divFillingText").style = "position: absolute; top: 70%; font-weight: bolder; font-size: 50px; left: 10%;";
      ...
      if (productVolumes.split("/")[0] >= 1000){
        vol6product1Detail1.innerHTML = productVolumes.split("/")[0]/1000;
        $("div#vol6product1volml").hide();
        $("div#vol6product1vol1").show();
      }else{
        vol6product1Detail1.innerHTML = productVolumes.split("/")[0];
        $("div#vol6product1volml").show();
        $("div#vol6product1vol1").hide();
      }

      if (productVolumes.split("/")[1] >= 1000){
        vol6product2Detail1.innerHTML = productVolumes.split("/")[1]/1000;
        $("div#vol6product2volml").hide();
        $("div#vol6product2vol1").show();
      }else{
        vol6product2Detail1.innerHTML = productVolumes.split("/")[1];
        $("div#vol6product2volml").show();
        $("div#vol6product2vol1").hide();
      }

      if (productVolumes.split("/")[2] >= 1000){
        vol6product3Detail1.innerHTML = productVolumes.split("/")[2]/1000;
        $("div#vol6product3volml").hide();
        $("div#vol6product3vol1").show();
      }else{
        vol6product3Detail1.innerHTML = productVolumes.split("/")[2];
        $("div#vol6product3volml").show();
        $("div#vol6product3vol1").hide();
      }

      if (productVolumes.split("/")[3] >= 1000){
        vol6product4Detail1.innerHTML = productVolumes.split("/")[3]/1000;
        $("div#vol6product4volml").hide();
        $("div#vol6product4vol1").show();
      }else{
        vol6product4Detail1.innerHTML = productVolumes.split("/")[3];
        $("div#vol6product4volml").show();
        $("div#vol6product4vol1").hide();
      }

      if (productVolumes.split("/")[4] >= 1000){
        vol6product5Detail1.innerHTML = productVolumes.split("/")[4]/1000;
        $("div#vol6product5volml").hide();
        $("div#vol6product5vol1").show();
      }else{
        vol6product5Detail1.innerHTML = productVolumes.split("/")[4];
        $("div#vol6product5volml").show();
        $("div#vol6product5vol1").hide();
      }

      if (productVolumes.split("/")[5] >= 1000){
        vol6product6Detail1.innerHTML = productVolumes.split("/")[5]/1000;
        $("div#vol6product6volml").hide();
        $("div#vol6product6vol1").show();
      }else{
        vol6product6Detail1.innerHTML = productVolumes.split("/")[5];
        $("div#vol6product6volml").show();
        $("div#vol6product6vol1").hide();
      }
