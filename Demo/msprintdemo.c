	...
	while(1)
    {
        ...
        switch(ch)
        {
			...
			case 5:
				...
				// PrintString(buf,0);
				// snprintf(buf, sizeof buf, "    	BDT. %s", argv[5]);
				// PrintString(buf,0);
				// PrintFeedDot(8);
				// SetAlignment(0);
				// SetLeftmargin(82);
				...
				SetBold(1);
				SetFont(1);
				PrintString("Product Name: ",1);
				SetBold(0);
				PrintString(argv[4],0);
				if(strcmp(argv[4], "Vim") == 0){
					SetBold(1);
					PrintString("Product Category: ",1);
					SetBold(0);
					PrintString("Liquid Dishwash",0);
				}
				else {
					SetBold(1);
					PrintString("Product Category: ",1);
					SetBold(0);
					PrintString("Laundry Detergent",0);
				}
				SetBold(1);
				PrintString("Net Volume: ",1);
				SetBold(0);
				snprintf(buf, sizeof buf, "%s ml", argv[6]);
				PrintString(buf,0);
				...
				SetBold(1);
				PrintString("Expiry Date: ",1);
				SetBold(0);
				PrintString(argv[11],0);

				SetBold(1);
				PrintString("Price: ",1);
				SetBold(0);
				snprintf(buf, sizeof buf, "BDT. %s              BDS 1554", argv[5]);
				PrintString(buf,0);
				...
				SetAlignment(0);
				SetLeftmargin(35);
				PrintDiskbmpfile("/home/pi/Documents/shampoo/Demo/instructions.bmp");

				// SetAlignment(0);
				// SetLeftmargin(68);
				// PrintDiskbmpfile("/home/pi/Documents/shampoo/Demo/test1.bmp");
